...
exports.resolveRelativeModuleId = function(id, packageName) {
  id = exports.stripJSExtension(id);

  if (id.length > 2 && id.slice(0, 2) === './') {
    return packageName + '/' + id.slice(2);
  }

  return id;
};

exports.stripJSExtension = function(id) {
  if (id.length > 3 && id.slice(-3) === '.js') {
    return id.slice(0, -3);
  }
