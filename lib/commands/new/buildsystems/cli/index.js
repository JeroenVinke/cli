...
module.exports = function(project, options) {
  ...
  model.transpiler.source = path.posix.join(appRoot, '**/*' + model.transpiler.fileExtension);
  model.markupProcessor.source = path.posix.join(appRoot, '**/*' + model.markupProcessor.fileExtension);
  model.cssProcessor.source = path.posix.join(appRoot, '**/*' + model.cssProcessor.fileExtension);
